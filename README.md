...
1. Verifique se a instalação ocorreu com sucesso usando git --version.
...
##### Setar usuário
```
git config --global user.name "adriano Oliveira" 
```
##### Setar email
```
git config --global user.email "oliveira.ifam@gmail.com"
```
##### Setar editor
...
user.email=oliveira.ifam@gmail.com
...
Uma vez criado o diretório, vamos inicializá-lo com o comando git init  popularmente chamado de workspace:
```
$ git init
```
...
### Clonar um repositório remoto já existente
	...
	git clone https://github.com/Oliveira4driano/Git.git
...
Uma vez em staging, podemos agora realizar um commit das alterações rastreadas, inserindo a flag -m  coloca uma mensagem no commit. que salva as informações do staging no seu repositório local local repository.
